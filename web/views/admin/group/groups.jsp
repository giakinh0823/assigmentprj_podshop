                        ...
                        <div class="min-w-md bg-white rounded-lg border border-gray-200 shadow-md py-8 px-6">
                            <div class="flex flex-col items-center pb-5">
                                ...
                                <div class="flex mt-4 space-x-3">
                                    ...
                                    <a href="/admin/group/delete?id=${group.getId()}" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300">Delete</a>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
