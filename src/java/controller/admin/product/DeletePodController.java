 ...
 * @author giaki
 */
public class DeletePodController extends BaseAuthAdminController {
    ...
    protected boolean isPermissionGet(HttpServletRequest request) {
        ...
        int numDelete = userDB.getNumberOfPermission(user.getId(), "POD", "DELETE");
        return numDelete >= 1;
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Image> images = imageDB.findByPod(id);
            FileManage fileManage = new FileManage();
            String folder = request.getServletContext().getRealPath("/assets/images/pods");
            ...
            Logger.getLogger(DeletePodController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
