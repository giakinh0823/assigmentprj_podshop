...
<html>
    ...
    <body>
        ...
        <script>
            ...
            $("#brand").val("${pod.brand}"),
            $("#price").val(${pod.price}),
            $("#quantity").val(${pod.quantity}),
            $("#discount").val(${pod.discount}),
            $("#state").val(${pod.state.id}),
            $("#description").val(`${pod.description}`),
            $("#isSale").prop('checked', ${pod.isSale});
    
            new_editor.setData(`${pod.content}`)
