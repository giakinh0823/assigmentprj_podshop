                    ...
                    <div class="container w-full grid grid-cols-5 gap-2 mx-auto">
                        ...
                        <div class="col-span-3 px-3 h-full flex flex-col">
                            ...
                            <div class="mt-6">
                                ...
                                <div class="flex items-center border-solid border-2 border-blue-600" style="width: fit-content">
                                    <button id="button-minus" type="button" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-1 focus:ring-blue-600 font-medium px-2 py-2 text-center text-sm">
                                    ...
                                    <button id="button-plus" type="button" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-1 focus:ring-blue-600 font-medium px-2 py-2 text-center text-sm">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                                    </button>                            
                                </div>
                            </div>
                            <button id="button-add-to-cart" type="button" class="max-w-lg mt-5 text-white bg-blue-600 hover:bg-blue-700 focus:ring-1 focus:ring-blue-600 font-medium px-15 py-2 text-center text-lg">
                                THÊM VÀO GIỎ HÀNG
                            </button> 
                        </div>
                    </div>
                        ...
                        <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                            <ul class="flex flex-wrap -mb-px" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                                <li class="mr-2" role="presentation">
                                    <button class="inline-block py-4 px-4 text-sm font-medium text-center text-gray-500 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 active" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="true">Dashboard</button>
                                </li>
                                <li class="mr-2" role="presentation">
                                    <button class="inline-block py-4 px-4 text-sm font-medium text-center text-gray-500 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 "id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">Settings</button>
                                </li>
                                <li role="presentation">
                                    <button class="inline-block py-4 px-4 text-sm font-medium text-center text-gray-500 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300" id="contacts-tab" data-tabs-target="#contacts" type="button" role="tab" aria-controls="contacts" aria-selected="false">Contacts</button>
                                </li>
                            </ul>
                        </div>
                        <div id="myTabContent">
